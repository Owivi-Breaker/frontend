                ...
                <div v-for="item in swiperExample" :key="item.id">
                    ...
                    <swiper v-bind="item.options">
                        <swiper-slide v-for="i in 5" :key="i">
                            <div class="flex-center h-240px border-1px border-[#999] text-18px font-bold">Slide{{
                                    i
                                }}
                            </div>
                        </swiper-slide>
...
import {GithubLink, WebSiteLink} from '@/components';

type SwiperExampleOptions = Pick<SwiperOptions,
    | 'navigation'
    | 'pagination'
    | 'scrollbar'
    | 'slidesPerView'

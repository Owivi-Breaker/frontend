<template>
  <div>
    ...
    <n-grid v-if="gameResult" x-gap="10" cols="3" style="text-align: center; margin: 10px auto">
      <n-gi>
        <n-card>
          ...
          <p>
            边路内切：{{ gameResult.teams_info[0].under_cutting_success }}/{{ gameResult.teams_info[0].under_cutting }}
          </p>
          <p>倒三角：{{ gameResult.teams_info[0].pull_back_success }}/{{ gameResult.teams_info[0].pull_back }}</p>
          <p>
            中路渗透：{{ gameResult.teams_info[0].middle_attack_success }}/{{ gameResult.teams_info[0].middle_attack }}
          </p>
          <p>
        ...
        <div style="margin: 10px auto">
          <endGameTeamData :player-info="gameResult.teams_info[0].players_info" style="height: 406px"></endGameTeamData>
        </div>
      </n-gi>
      <n-gi>
      ...
      <n-gi>
        <n-card>
          ...
          <p>
            边路内切：{{ gameResult.teams_info[1].under_cutting_success }}/{{ gameResult.teams_info[1].under_cutting }}
          </p>
          <p>倒三角：{{ gameResult.teams_info[1].pull_back_success }}/{{ gameResult.teams_info[1].pull_back }}</p>
          <p>
            中路渗透：{{ gameResult.teams_info[1].middle_attack_success }}/{{ gameResult.teams_info[1].middle_attack }}
          </p>
          <p>
        ...
        <div style="margin: 10px auto">
          <endGameTeamData :player-info="gameResult.teams_info[1].players_info" style="height: 406px"></endGameTeamData>
        </div>
      </n-gi>
    </n-grid>
  </div>

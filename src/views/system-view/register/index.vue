<template>
  <div class="registerDiv">
    ...
    <p id="title">注册</p>
    <n-form id="form" ref="formRef" :show-label="false" :model="formValue" :rules="rules">
      ...
      <n-form-item>
        <n-button class="roundButton" type="primary" attr-type="button" @click="postRegister">立即注册</n-button>
      </n-form-item>
    </n-form>
    <div>
      已经有账号？

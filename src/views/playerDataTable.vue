<template>
    ...
    <n-tabs default-value="capa" size="large" type="card">
        <n-tab-pane name="capa" tab="能力">
            <n-data-table :columns="capaColumns" :data="capaData" :loading="this.store.capaLoading" striped />
        </n-tab-pane>
        <n-tab-pane name="perf" tab="表现">
            <n-data-table :columns="perfColumns" :data="perfData" :loading="this.store.perfLoading" striped />
        </n-tab-pane>
    </n-tabs>
</template>

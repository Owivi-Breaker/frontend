<template>
  <div class="selectSaveDiv">
    ...
    <n-select class="selectSave" placeholder="请选择" v-model:value="choseSave" :options="saveList" v-on:click="GetSave"
    ...
    <div class="saveButtonDiv">
      <n-button class="newSaveButton" type="primary" v-on:click="leagueShowModal = true" attr-type="button">新建存档
      </n-button>
      ...
      <n-layout has-sider>
        <n-layout-sider content-style>
          <n-scrollbar class="competetionMenuBar">
            <n-menu :default-value="competitionList[0].label" @update:value="ChangeCompetition" :collapsed-width="64"
        ...
        <n-layout>
          <n-scrollbar class="teamBar">
            ...
            >
              ...
              <n-button class="goButton" type="primary" v-show="showGoButton == index" v-on:click="NewSave(index)">
                就选他！
              </n-button>
            </n-card>
          </n-scrollbar>

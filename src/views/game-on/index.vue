    ...
    <div class="p-6">
        <div class="flex gap-6" >
            <div class="w-1/3 flex flex-col gap-6">
                <!-- 左球场 -->
                <Field pos="left" v-if="!isLoading"></Field>
                <!-- 左表格 -->
                <div>
            ...
            <div class="w-1/3">
                <div class="flex flex-col gap-6">
                    <!-- 比分 -->
                    <GameStatus v-if="totalData['game_info']" :computer-team-info="totalData['computer_team_info']"
                        :home-club-id="totalData['game_info']['home_club_id']"
                        :player-team-info="totalData['player_team_info']" :turns="totalData['game_info']['turns']"
                        :cur-attacker="totalData['game_info']['cur_attacker']"></GameStatus>
                    <!-- 战术选择 -->
                    ...
                    <div class="s-card p-6">
                        ...
                        <div class="flex flex-col gap-3 items-start">
                            <div v-for="script in newCommentaryList" class="flex items-center gap-2">
                                <div class="text-primary bg-primary-active rounded-full py-1 px-2">{{ script.time }}
                                </div>
                    ...
                    <!-- 战术统计 -->
                    <TacticalStatistic :computer-team-info="totalData['computer_team_info']"
                        :player-team-info="totalData['player_team_info']"></TacticalStatistic>
                    <!-- 解说 -->
            ...
            <div class="w-1/3 flex flex-col gap-6">
                <!-- 右球场 -->
                <Field pos="right" v-if="!isLoading"></Field>
                <!-- 右表格 -->
                <div>
